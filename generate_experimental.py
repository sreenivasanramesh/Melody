...
def generate(model_name, weights_file, num_units=128, sequence_length=100, test_file=None):
...
def generate_notes(model, sequence_length, test_file=None):
    ...
    for note_index in range(500):
        ...
        if random.random() < 0.4:
            ...
            dist = tf.compat.v1.distributions.Multinomial(total_count=3., logits=top)
